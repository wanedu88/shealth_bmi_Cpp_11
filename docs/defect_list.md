...
### DEF-001 — BMI 경계 25.0 비만 미적용 ✅ Fixed
...
| 단계 | 내용 |
|------|------|
| Given | `test/fixtures/tc16_bmi_25.csv` — age 25, weight **72.25**, height 170 |
...
**2) 픽스처** — `tc16_bmi_25.csv` weight **72.25** (BMI=25.0)
...
| 수정 후 `SHealth.cpp` | **`≥25` 비만** — README·`test_plan` 일치 |

**검증:** `ctest` 26/26 Green, TC_16·TC_18 통과.
...
| 조치 | DEF-001 적용 후 **TC_18·TC_16** 회귀 — **통과** (2026-05-20) |
